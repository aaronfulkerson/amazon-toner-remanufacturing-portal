...
export const PERMISSIONS: Permissions = {
  CARTRIDGES: {
    ...
    [USER_ROLE.EMPLOYEE]: [PERMISSION_NAME.TONER],
  ...
  REMANUFACTURING: {
    [USER_ROLE.ADMIN]: true,
    [USER_ROLE.CUSTOMER]: false,
    [USER_ROLE.EMPLOYEE]: [PERMISSION_NAME.REMANUFACTURING],
    [USER_ROLE.TECHNICIAN]: false,
  },
  SALES: {
    [USER_ROLE.ADMIN]: true,
  ...
  SERVICE: {
    [USER_ROLE.ADMIN]: true,
    [USER_ROLE.CUSTOMER]: false,
    [USER_ROLE.EMPLOYEE]: [PERMISSION_NAME.SERVICE],
...
export const VALID_ROLE_PERMISSIONS = {
  [USER_ROLE.CUSTOMER]: [PERMISSION_NAME.TONER],
  [USER_ROLE.EMPLOYEE]: [
